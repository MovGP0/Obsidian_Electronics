---
title: Spin Hall Effect (SHE) Magnetic Tunnel Junction (MTJ) SPICE Models
---
The spin Hall effect model extends the STT framework with a spin Hall metal (SHM). The model includes both MTJ and SHM dimensions and material parameters, plus user-controlled initial angle and thermal fluctuation.

## Supported operation modes

We have four operating modes:
...
The examples include `MTJ_write.sp` for SHE-assisted STT and `MTJ_write_SHE_ONLY.sp` for SHE-only switching.
...
### SHE_model\SHE_model\HeatDF.inc
...
### SHE_model\SHE_model\LLG_solver.inc
...
### SHE_model\SHE_model\MTJ_model.inc
...
### SHE_model\SHE_model\MTJ_write_SHE_ONLY.sp
...
### SHE_model\SHE_model\MTJ_write.sp
...
### SHE_model\SHE_model\NoiseGen_MATLAB.m
...
### SHE_model\SHE_model\pwlFile_92.in
...
### SHE_model\SHE_model\Resistor.inc
